...
The results can be found into [results_msp_ml_me.txt](eval/results_eval/results_table1.txt) file for the inference and into [miou_msp_ml_me.txt](eval/results_miou/miou_msp_ml_me.txt) file for the miou.
